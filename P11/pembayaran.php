<html>
    ...
    <body>
        ...
        <p class="note">Scan Kode QR di atas ini dengan aplikasi digital wallet / m-banking untuk melakukan pembayar.</p>
        <small class="note">Bukti Pembayaran akan dikirim ke email <?php echo htmlspecialchars($email); ?></small>
        <div class="actions">
